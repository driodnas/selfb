...
cl = LINETCR.LINE()
cl.login(token="EqdfYhLeMt8WaF1I48hf.JaIcRyc14sLXZI5dJNLfhW.6ZxlRkTPxZMyEfFMwZie2tADcg7J1RpV9CURQO0E/EQ=")
cl.loginResult()
...
#==============================================================================# 
        if op.type == 5:
            if settings["autoAdd"] == True: 
                ...
                cl.sendText(op.param1, "Halo " + xname + " ,thanks for adding me as a friend :3")
        if op.type == 13:
            if mid in op.param3:
        ...
        if op.type == 22:
            if settings["autoLeaveRoom"] == True:
                cl.sendText(op.param1, "What do I invite?")
            ...
            if msg.contentType == 13:
                if settings["checkContact"] == True:
                    try:
                        ...
                        cl.sendText(msg.to, "Invalid contact")
...
#==============================================================================#
    ...
    #==============================================================================#
                    ...
                    cl.sendText(msg.to, "Successfully broadcast to {} group".format(str(len(groups))))
                    ...
                    cl.sendText(msg.to, "Successfully broadcast to {} teman".format(str(len(friends))))
                    ...
                    if msg.toType == 2:
                        ...
                        if group.invitee is not None:
                            try:
                               ...
                               cl.sendText(msg.to,"No Pending Invitations")
    #==============================================================================#
    #================================= SELF GROUP =================================#
    #==============================================================================#
    ...
    #==============================================================================#
                    ...
                    if mimic["target"] == {}:
                        cl.sendText(msg.to,"No Mimic List")
                    else:
                        mc = "═════════List Member═════════\n"
    ...
    #==============================================================================#
                    ...
                    if msg.to in read["readPoint"]:
                        ...
                        cl.sendText(msg.to, "Lurking has not been activated")
                    ...
                    with requests.session() as web:
                        ...
                        try:
                            ...
                            for song in data:
                                ...
                                ret_ += "\n╚══[ Waiting Audio ]"
                                cl.sendText(msg.to, str(ret_))
                                cl.sendText(msg.to, "Please be patient, For your music")
